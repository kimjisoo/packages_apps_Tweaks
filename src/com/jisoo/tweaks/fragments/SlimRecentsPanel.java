...
import com.jisoo.tweaks.preferences.SystemSettingSwitchPreference;
import com.jisoo.tweaks.preferences.CustomSeekBarPreference;
...
public class SlimRecentsPanel extends SettingsPreferenceFragment implements
    ...
    private static final String RECENT_APP_SIDEBAR_SCALE_FACTOR =
            "recent_app_sidebar_scale_factor";
    private static final String RECENT_APP_SIDEBAR_BG_COLOR =
    ...
    private CustomSeekBarPreference mRecentSidebarScale;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mRecentPanelLeftyMode) {
            ...
            return true;
        } else if (preference == mRecentSidebarScale) {
            Settings.System.putInt(getContext().getContentResolver(),
    ...
    private void updateRecentPanelPreferences() {
        ...
        final int recentSidebarScale = Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.RECENT_APP_SIDEBAR_SCALE_FACTOR, 115);
        mRecentSidebarScale.setValue(recentSidebarScale);
    }
    ...
    private void initializeAllPreferences() {
        ...
        mRecentSidebarScale =
                (CustomSeekBarPreference) findPreference(RECENT_APP_SIDEBAR_SCALE_FACTOR);
        mRecentSidebarScale.setOnPreferenceChangeListener(this);
